...
public class RecyclerStoreAdapter extends RecyclerView.Adapter<RecyclerStoreAdapter.ViewHolder> {
    ...
    public RecyclerStoreAdapter(List<StoreRecyclerModel> items) {
        this.items = items;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(App.CONTEXT).inflate(R.layout.item_recycler_store,viewGroup,false);
